...
if (!BROWSER) {
  ...
  p2p.RTCPeerConnection     = wrtc.RTCPeerConnection;
  p2p.RTCSessionDescription = wrtc.RTCSessionDescription;
  p2p.RTCIceCandidate       = wrtc.RTCIceCandidate;
}
else {
  p2p.RTCPeerConnection = window.mozRTCPeerConnection
                          || window.webkitRTCPeerConnection
                          || window.RTCPeerConnection;;
  p2p.RTCSessionDescription = window.mozRTCSessionDescription
                          || window.webkitRTCSessionDescription
                          || window.RTCSessionDescription;
  p2p.RTCIceCandidate = window.mozRTCIceCandidate

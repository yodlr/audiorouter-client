...
var failureInterval = 30000; //how long to wait before a timeout is considered a failure (and retries stop)
...
var PCClient = module.exports = function PCClient(options) {
  ...
  client._pcConfig = {
    'iceServers': [
      ...
      {'url': 'stun:turn.getyodlr.com:3478'},
      {
        "url": "turn:turn.getyodlr.com:3478?transport=udp",
        "username": "yodlrturn",
        "credential": "i78mv7u7PG7aVJ7"
      },
      {
        "url": "turn:turn.getyodlr.com:3478?transport=tcp",
        "username": "yodlrturn",
        "credential": "i78mv7u7PG7aVJ7"
      },
      {
        "url": "turn:turn.getyodlr.com:3479?transport=udp",
        "username": "yodlrturn",
        "credential": "i78mv7u7PG7aVJ7"
      },
      {
        "url": "turn:turn.getyodlr.com:3479?transport=tcp",
        "username": "yodlrturn",
        "credential": "i78mv7u7PG7aVJ7"
      }
    ]
